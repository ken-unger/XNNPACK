...
################################ RISC-V Vector ################################
tools/xngen src/f32-rdsum2/rvv.c.in -D ACCUMULATORS=7 LMUL=1 -o src/f32-rdsum2/gen/f32-rdsum2-7p7x-minmax-rvv-u1v.c &
tools/xngen src/f32-rdsum2/rvv.c.in -D ACCUMULATORS=7 LMUL=2 -o src/f32-rdsum2/gen/f32-rdsum2-7p7x-minmax-rvv-u2v.c &
