...
################################### RISCV FP16 Vector ############################
tools/xngen src/f16-rminmax/rvvfp16arith.c.in -D LMUL=1 -D OP=MAX -o src/f16-rminmax/gen/f16-rmax-rvvfp16arith-u1v.c &
tools/xngen src/f16-rminmax/rvvfp16arith.c.in -D LMUL=2 -D OP=MAX -o src/f16-rminmax/gen/f16-rmax-rvvfp16arith-u2v.c &
tools/xngen src/f16-rminmax/rvvfp16arith.c.in -D LMUL=4 -D OP=MAX -o src/f16-rminmax/gen/f16-rmax-rvvfp16arith-u4v.c &
tools/xngen src/f16-rminmax/rvvfp16arith.c.in -D LMUL=8 -D OP=MAX -o src/f16-rminmax/gen/f16-rmax-rvvfp16arith-u8v.c &

tools/xngen src/f16-rminmax/rvvfp16arith.c.in -D LMUL=1 -D OP=MIN -o src/f16-rminmax/gen/f16-rmin-rvvfp16arith-u1v.c &
tools/xngen src/f16-rminmax/rvvfp16arith.c.in -D LMUL=2 -D OP=MIN -o src/f16-rminmax/gen/f16-rmin-rvvfp16arith-u2v.c &
tools/xngen src/f16-rminmax/rvvfp16arith.c.in -D LMUL=4 -D OP=MIN -o src/f16-rminmax/gen/f16-rmin-rvvfp16arith-u4v.c &
tools/xngen src/f16-rminmax/rvvfp16arith.c.in -D LMUL=8 -D OP=MIN -o src/f16-rminmax/gen/f16-rmin-rvvfp16arith-u8v.c &

tools/xngen src/f16-rminmax/rvvfp16arith.c.in -D LMUL=1 -D OP=MINMAX -o src/f16-rminmax/gen/f16-rminmax-rvvfp16arith-u1v.c &
tools/xngen src/f16-rminmax/rvvfp16arith.c.in -D LMUL=2 -D OP=MINMAX -o src/f16-rminmax/gen/f16-rminmax-rvvfp16arith-u2v.c &
tools/xngen src/f16-rminmax/rvvfp16arith.c.in -D LMUL=4 -D OP=MINMAX -o src/f16-rminmax/gen/f16-rminmax-rvvfp16arith-u4v.c &
tools/xngen src/f16-rminmax/rvvfp16arith.c.in -D LMUL=8 -D OP=MINMAX -o src/f16-rminmax/gen/f16-rminmax-rvvfp16arith-u8v.c &
