...
void xnn_f16_gemm_minmax_ukernel_7x4v__rvvfp16arith(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_f16_minmax_params* restrict params)
{
  ...
  const _Float16* a1 = (const _Float16*) ((uintptr_t) a0 + a_stride);
  _Float16* c1 = (_Float16*) ((uintptr_t) c0 + cm_stride);
  if XNN_UNPREDICTABLE(mr < 2) {
    a1 = a0;
    c1 = c0;
  }
  const _Float16* a2 = (const _Float16*) ((uintptr_t) a1 + a_stride);
  _Float16* c2 = (_Float16*) ((uintptr_t) c1 + cm_stride);
  if XNN_UNPREDICTABLE(mr <= 2) {
    a2 = a1;
    c2 = c1;
  }
  const _Float16* a3 = (const _Float16*) ((uintptr_t) a2 + a_stride);
  _Float16* c3 = (_Float16*) ((uintptr_t) c2 + cm_stride);
  if XNN_UNPREDICTABLE(mr < 4) {
    a3 = a2;
    c3 = c2;
  }
  const _Float16* a4 = (const _Float16*) ((uintptr_t) a3 + a_stride);
  _Float16* c4 = (_Float16*) ((uintptr_t) c3 + cm_stride);
  if XNN_UNPREDICTABLE(mr <= 4) {
    a4 = a3;
    c4 = c3;
  }
  const _Float16* a5 = (const _Float16*) ((uintptr_t) a4 + a_stride);
  _Float16* c5 = (_Float16*) ((uintptr_t) c4 + cm_stride);
  if XNN_UNPREDICTABLE(mr < 6) {
    a5 = a4;
    c5 = c4;
  }
  const _Float16* a6 = (const _Float16*) ((uintptr_t) a5 + a_stride);
  ...
  do {
    ...
    do {
      ...
      const _Float16 va1 = *a1++;
      const _Float16 va2 = *a2++;
      const _Float16 va3 = *a3++;
      const _Float16 va4 = *a4++;
      const _Float16 va5 = *a5++;
      const _Float16 va6 = *a6++;
    ...
    a1 = (const _Float16*) ((uintptr_t) a1 - kc);
    a2 = (const _Float16*) ((uintptr_t) a2 - kc);
    a3 = (const _Float16*) ((uintptr_t) a3 - kc);
    a4 = (const _Float16*) ((uintptr_t) a4 - kc);
    a5 = (const _Float16*) ((uintptr_t) a5 - kc);
    a6 = (const _Float16*) ((uintptr_t) a6 - kc);
  } while (nc != 0);
}
