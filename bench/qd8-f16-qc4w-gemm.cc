...
#include "src/xnnpack/packw.h"
  ...
  static void qd8_f16_qc4w_gemm_minmax_ukernel_1x4v__rvvfp16arith(benchmark::State& state, const char* net) {
    GEMMBenchmark(state,
  ...
  BENCHMARK_GEMM(qd8_f16_qc4w_gemm_minmax_ukernel_1x4v__rvvfp16arith)

  static void qd8_f16_qc4w_gemm_minmax_ukernel_4x4v__rvvfp16arith(benchmark::State& state, const char* net) {
    GEMMBenchmark(state,
  ...
  BENCHMARK_GEMM(qd8_f16_qc4w_gemm_minmax_ukernel_4x4v__rvvfp16arith)

  static void qd8_f16_qc4w_gemm_minmax_ukernel_7x4v__rvvfp16arith(benchmark::State& state, const char* net) {
    GEMMBenchmark(state,
  ...
  BENCHMARK_GEMM(qd8_f16_qc4w_gemm_minmax_ukernel_7x4v__rvvfp16arith)
